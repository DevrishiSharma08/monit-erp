...
const NAV_ADMIN: TopItem[] = [
  ...
  { type: "leaf", name: "Stock Lots",         href: "/stock-lots",      icon: Package        },
  {
    ...
    items: [
      ...
      // { type: "leaf", name: "GSM Master",          href: "/masters/stock-category", icon: Hash        },
      // { type: "leaf", name: "Unit Master",         href: "/masters/units",          icon: Ruler       },
      ...
      // { type: "leaf", name: "Salesman Master",  href: "/masters/salesmen",       icon: UserCheck   },
