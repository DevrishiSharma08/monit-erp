                  ...
                  <tr key={headerGroup.id}>
                    ...
                    >
                      {headerGroup.headers.map((header) => (
                        <th
                          key={header.id}
                          className="relative px-3 py-3 font-semibold text-gray-700 select-none whitespace-nowrap text-[11px] uppercase tracking-wider"
                        >
                ...
                {table.getRowModel().rows.map((row, rowIdx) => (
                  ...
                  >
                    {row.getVisibleCells().map((cell) => (
                      <td
                        key={cell.id}
                        className="px-3 py-2.5 text-gray-600 whitespace-nowrap group-hover:text-gray-900 transition-colors duration-100"
                      >
                        {flexRender(
